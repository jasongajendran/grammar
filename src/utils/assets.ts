...
export const VISUAL_STUDY_PREP: Record<string, VisualStudyCard> = {
  ...
  'l1-adjectives': {
    ...
    image: partsOfSpeechChestImg,
    imageAlt: 'Visual palette of adjectives painting vivid colors, numbers, and details on nouns',
    badge: 'Visual Memory Anchor',
    title: 'The Adjective Color Palette & Counter',
    mnemonic: 'What kind? Which one? How many?',
    visualAnchor: '🎨 Color Palette & 🔢 Number Counter = Adjectives telling WHAT KIND (clever, green), HOW MANY (two foxes, three coins), or WHICH ONE (first bus).',
    keyRule: 'Adjectives modify nouns to specify color, size, quality (clever), or number and quantity (two, ten, many).',
    illustratedClue: 'Look for words telling what kind (frosty) or how many (two) right before a noun!',
    companionTip: 'Lady Clementine says: "Remember: numbers like *two* or *three* before a noun count as adjectives answering *how many?*!"',
  },
